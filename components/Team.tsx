...
const Team: React.FC = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      // Background Color Change Trigger removed - handled by ThemeController
  ...
  return (
    <section id="team" ref={container} className="py-32 text-zinc-900 min-h-screen">
      <div className="container mx-auto px-6">

        <div className="mb-24 max-w-3xl team-header opacity-0">
          <h2 className="text-6xl md:text-8xl font-bold mb-8 tracking-tighter uppercase leading-[0.9]">
            {CONTENT.team.headline}
          </h2>
          <p className="text-xl md:text-2xl font-light leading-relaxed max-w-2xl opacity-60">
